...
namespace JOC
{
    public partial class Form1 : Form
    {
        ...
        private void KeyIsDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode==Keys.Up)
            {
                goUp = true;/*o functie de genul goDirectie o folosesc pentru controlul avionului*/ 
            }
            if(e.KeyCode==Keys.Down)
            {
                goDown = true;
        ...
        {
            GameTimer.Stop();
            txtScore.Text = "Score=" + score + " Ai pierdut, apasa pe enter pentru a juca din nou";
            gameOver = true;
        }
        ...
        private void ChangeUFO()
        {
            ...
            {
                case 1:
                    ufo.Image = Properties.Resources.Pasare1;
                    break;
                case 2:
                    ufo.Image = Properties.Resources.Pasare2;
                    break;
            }

            ufo.Left = 1000;
            ufo.Top = rand.Next(20, this.ClientSize.Height);
